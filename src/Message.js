		...
		<div>
			{
				...
				<div className="message">
					<div style={{visibility:block?"visible":"hidden"}} className="share-main">
						<Prohibit size={30} color="#1EBA60" />
						<p>Block <span>Kathryn Murphy</span> ?</p>
						<div className="great-btn">
							<button onClick={onCancel}>Cancel</button>
							<button onClick={onBack}>Yes, Block</button>
						</div>
					</div>
					<div className={block?"success":"message"}>
						<div className="bookmark-top">
							...
							<div className="prayer2-top">
								<button onClick={onBtnblock} className="dot3">
